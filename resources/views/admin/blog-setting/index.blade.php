          ...
          <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('admin.blog-section-setting.update',1)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Enable Blog Section</label>
                      <div class="col-sm-12 col-md-7">
                        <x-toggle name="is_enabled" :checked="$blogTitle?->is_enabled" label="" />
                      </div>
                    </div>
