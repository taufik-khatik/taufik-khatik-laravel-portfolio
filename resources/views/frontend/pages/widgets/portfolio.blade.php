                        ...
                        <div class="single-portfolio">
                            ...
                            <div class="portfolio-content">
                                <div class="portfolio-icons">
                                    <a title="Preview Image" href="{{ asset($item?->image) }}" data-lity class="icon"><i class="fas fa-eye"></i></a>
                                    <a title="View Details" href="{{ route('show.portfolio', $item?->id) }}" class="icon"><i class="fas fa-link"></i></a>
                                </div>
                                <h4 title="View Details" class="title">
